<template>
  ...
  <div class="flex flex-col justify-center h-full">
    ...
    <span class="text-center text-zinc-500"
      >Preencha o formulário abaixo para criar seu acesso</span
    >
    ...
    <form class="px-10 md:px-20">
      ...
      <button
        @click="onSubmit()"
        type="button"
        class="py-3 px-5 from-zinc-700 to-zinc-900 rounded-lg text-white w-full hover:from-green-300 hover:to-green-500 bg-gradient-to-r mt-8"
      >
        <b>CRIAR CONTA</b>
      </button>
...
const { data, status, execute } = useFetch("/api/create-account", {
  immediate: false,
  method: "post",
  body,
  watch: false,
